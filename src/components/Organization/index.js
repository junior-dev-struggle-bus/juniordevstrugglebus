           ...
           <section className="imageblock about-1 bg--secondary">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <h1 style={{paddingBottom:'1em'}}>About the Junior Dev Struggle Bus</h1>
                            <p>
            ...
            <Aboutsection id="exec">
              <h3 style={{color:'white',padding:'0 0 1em 0'}}>The Executive Team and Board of Directors</h3>
              <h4 style={{color:'white',padding:'0 0 1em 0'}}>Board of Directors</h4>
              ...
              <h4 style={{color:'white',padding:'1em 0 1em 0'}}>Executive Team</h4>
